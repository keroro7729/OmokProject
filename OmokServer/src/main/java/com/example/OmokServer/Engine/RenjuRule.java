...
import com.example.OmokServer.Enums.CellState;
import com.example.OmokServer.Enums.GameState;
import com.example.OmokServer.Enums.PutError;
...
public class RenjuRule extends OpenRule {
    ...
    protected  boolean putable(int coor, int color){
        return putable(getX(coor), getY(coor), color);
    }
